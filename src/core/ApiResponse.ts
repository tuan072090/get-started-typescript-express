...
abstract class ApiResponse {
    ...
    protected constructor(protected code?: StatusCode, protected status?: ResponseStatus, protected message?: string) {
    }
...
export class SuccessResponse extends ApiResponse {
    constructor(private data: any) {
        super(StatusCode.SUCCESS, ResponseStatus.SUCCESS);
    }
